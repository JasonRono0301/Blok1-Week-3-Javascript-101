...
var smallPizza = prompt('Hoeveel small pizza wilt u?');//Het aantal small Pizza dat de gebruiker wilt bestellen.
    alert('Uw aantal bestelde small pizza:'+' '+ Number(smallPizza));//Geeft een alert aan hoeveel small Pizza de gebruiker heeft besteld.
...
var mediumPizza = prompt('Hoeveel medium pizza wilt u?');//Het aantal medium pizza dat de gebruiker wilt bestellen.
    alert('Uw aantal bestelde medium pizza:'+' '+ Number(mediumPizza));//Geeft een alert aan hoeveel medium pizza de gebruiker heeft besteld.
...
var largePizza = prompt('Hoeveel large pizza wilt u bestellen?');//Het aantal large pizza dat de gebruiker wilt bestellen.
    alert('Uw aantal bestelde large pizza:'+' '+Number(largePizza));//Geeft een alert aan hoeveel large pizza de gebruiker heeft besteld.
        const LARGEPRICE = 5.00;//Prijs per large pizza.
            ...
            //Hieronder word alle aantal bestelde pizza's weergegeven op het beeldscherm nadat alles is besteld.
